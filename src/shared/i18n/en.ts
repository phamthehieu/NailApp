...
const en: Translations = {
    ...
    checkin: {
        ...
        skip: 'SKIP →',
        pleaseEnterPhone: 'Please enter your cell phone number',
        yourInfoNotShared: 'Your info will not be shared',
        sologanhapsoDT: 'Please enter your phone number to verify your appointment',
        nhapsoDT: 'Enter phone number',
        confirmButton: 'Confirm booking',
        next: 'NEXT',
        delete: 'Delete',
        consentText: 'By checking the box and clicking NEXT, you give Nails Booking, express written consent to contact you at the number entered for reminder or promotional purposes. Consent is not required to make a purchase. You also agree to the Terms and Conditions/Privacy Policy and Store Policies',
