const vi = {
  ...
  checkin: {
    ...
    invalidEmailMessage: 'Vui lòng nhập email hợp lệ',
    ...
    createAccountErrorTitle: 'Tạo tài khoản thất bại',
    createAccountNoOtpMessage: 'Không lấy được mã xác thực. Vui lòng thử lại.',
    tryAgainMessage: 'Vui lòng thử lại.',
    invalidOtpTitle: 'Mã OTP không hợp lệ',
    invalidOtpMessage: 'Vui lòng nhập đúng 6 số OTP.',
    cannotCheckinTitle: 'Chưa thể check-in',
    cannotCheckinMessage: 'Vui lòng thử lại sau khi tạo tài khoản.',
    otpErrorTitle: 'Xác thực OTP thất bại',
    notCreatedAccountTitle: 'Chưa tạo tài khoản',
    notCreatedAccountMessage: 'Bạn có muốn tạo tài khoản trước khi check-in?',
    createAccountOkText: 'Đồng ý',
    createAccountCancelText: 'Từ chối',
    registerModalTitle: 'Tạo tài khoản',
    otpModalTitle: 'Nhập mã OTP',
    lastNameLabel: 'Họ',
    ...
    otpSentInfo: 'Mã OTP đã được gửi tới {{phone}}.',
    didNotReceiveOtp: 'Chưa nhận được mã?',
    resendOtpNow: 'Gửi lại mã',
  ...
  permission: {
    notApplicable: 'Không áp dụng cho hệ điều hành này',
    notRequired: 'Thiết bị này không yêu cầu xin quyền notification',
    alreadyGranted: 'Đã có quyền gửi thông báo',
    granted: 'Đã cấp quyền gửi thông báo',
    denied: 'Người dùng đã từ chối quyền',
    deniedNeverAskAgain: 'Người dùng đã từ chối và chọn không hỏi lại',
    requestTitle: 'Quyền gửi thông báo',
    requestMessage: 'Ứng dụng cần quyền gửi thông báo để thông báo cho bạn về các đặt lịch và cập nhật quan trọng.',
    buttonNeutral: 'Để sau',
    buttonNegative: 'Từ chối',
    buttonPositive: 'Đồng ý',
    deniedTitle: 'Quyền bị từ chối',
    deniedMessage: 'Bạn đã từ chối quyền gửi thông báo. Để bật lại, vui lòng vào Cài đặt > Ứng dụng > NailApp > Quyền và bật thông báo.',
    deniedButton: 'Đã hiểu',
    errorTitle: 'Lỗi',
    errorMessage: 'Lỗi khi xin quyền: {{error}}',
    errorUnknown: 'Lỗi không xác định',
    settingsErrorTitle: 'Lỗi',
    settingsErrorMessage: 'Không thể mở cài đặt ứng dụng. Vui lòng mở thủ công trong Cài đặt > Ứng dụng > NailApp.',
    checkError: 'Lỗi khi kiểm tra quyền notification',
    requestError: 'Lỗi khi xin quyền notification',
    settingsError: 'Không thể mở cài đặt',
  },
};
